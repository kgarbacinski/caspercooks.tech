    ...
    <section id="studio" className="relative pt-12 sm:pt-16 pb-12 sm:pb-16 scroll-mt-20 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        <div className="flex items-end justify-between gap-8 mb-14 sm:mb-16">
          <SectionHeader index={theme === 'developer' ? '05' : '04'} eyebrow={"tiktok --\u2060lang=pl --\u2060content=dev"} /* word joiner: flaga nie łamie się po „--” na wąskim telefonie */ title="Programming content in Polish" />
        </div>
