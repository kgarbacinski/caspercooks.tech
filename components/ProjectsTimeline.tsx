...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Built enterprise monolithic application for campaign management. Led technical team, designed architecture, and delivered robust solution handling high-traffic events for Redbull.',
    role: 'Tech Leader',
