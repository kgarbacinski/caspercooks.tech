 ...
 * jeden "pokój" z wyspy. Zasada ruchu: jedna warstwa tła (iskry + światła w hero),
 * jedna reakcja na kursor (hover pokoju), jeden duży moment (przełącznik DEV ⇄ CEO);
 * reszta to jednorazowe wejścia przy scrollu.
 */
